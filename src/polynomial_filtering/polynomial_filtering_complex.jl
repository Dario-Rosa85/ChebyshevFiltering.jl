...
function filtering_step!(search_vectors_list::Matrix{ComplexF64}, u_vectors::Vector{Vector{ComplexF64}}, w_vectors::Vector{Vector{ComplexF64}}, polynomial_degree_optim, full_coeff, hamiltonian_matrix::SparseMatrixCSC{ComplexF64, Int64})
...
function Rayleigh_Ritz_pairs_residuals!(Ritz_matrix::Matrix{ComplexF64}, Ritz_vectors::Vector{Vector{ComplexF64}}, search_vectors_list::Matrix{ComplexF64}, hamiltonian_matrix::SparseMatrixCSC{ComplexF64, Int64})
...
function Rayleigh_Ritz_matrix_building_single_chunk!(Ritz_matrix::Matrix{ComplexF64}, search_vectors_list::Matrix{ComplexF64}, hamiltonian_matrix::SparseMatrixCSC{ComplexF64, Int64}, chunk)
...
function Rayleigh_Ritz_matrix_building!(Ritz_matrix::Matrix{ComplexF64}, search_vectors_list::Matrix{ComplexF64}, hamiltonian_matrix::SparseMatrixCSC{ComplexF64, Int64})
    chunks = Iterators.partition(axes(search_vectors_list,2), Int64(floor(length(axes(search_vectors_list,2)) / (2 * Threads.nthreads()))))
    Threads.@sync for chunk in chunks
